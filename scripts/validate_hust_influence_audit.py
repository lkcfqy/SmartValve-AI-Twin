#!/usr/bin/env python3
"""Independently validate the post-hoc HUST physical-unit influence audit."""
...
from smartvalve.experiments.hust_influence_validation import validate_hust_influence_audit
...
def main() -> int:
    ...
    result = validate_hust_influence_audit(
        ...
        audit_summary=arguments.audit_summary,
        audit_summary_sha256=arguments.audit_summary_sha256,
    )
